  ...
  return (
    <Container size={'lg'}>
      <Stack gap='xs'>
        ...
        <Text>
          For individuals or organizations that support us, we offer various forms of appreciation, including but not limited to:
        </Text>
        <ul>
        ...
        <Text>
          If you’re interested in supporting our cause or learning more about partnership and sponsorship opportunities, we’d love to hear from you. Your support not only brings a stage to music lovers—it helps ignite the cultural spirit of our community.
        </Text>
      </Stack>
    </Container>
  );
